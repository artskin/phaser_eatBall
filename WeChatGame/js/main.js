...
window.WXhandler = require('libs/WXHandler.js');
...
var Device = wx.getSystemInfoSync();
  ...
  var endState = function (game) {
      this.create = function(){
          ...
          WXhandler.setUserCloudStorage(score);
          ...
          resultInfo = game.add.text(gameW/2,gameH/4,resultTxt,resultStyle);
          resultInfo.anchor.setTo(0.5, 0.5);

          WXhandler.getFriendCloudStorage();
          WXhandler.showRankList(game);
          ...
          function rePlay() {
            ...
            function drawRank(){
                ...
                context.drawImage(sharedCanvas, 0, 0, 375, 667);
                console.log(context);

                
                game.add.sprite(0,0,new PIXI.Texture(new PIXI.BaseTexture(context)));

         

                
                // var bmd = game.add.bitmapData(300, 400);
                // this.bmd.circle(size, size, size);


                
                //game.add.sprite(newRank)
