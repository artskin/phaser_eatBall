var handler = {
  ...
  getFriendCloudStorage:function(){
    wx.getFriendCloudStorage({
      keyList:["score"],
      success:function(data){
        console.log("1111game.js->index.js getFriendCloudStorage success:",data);
  ...
  drawRankList:function(arrayData){
    ...
    for(var i=0,len = arrayData.length;i<len;i++){
      ...
      context.fillText(score,    260, baseLine + lineHeight / 2+5);
      img.src = avatarUrl;
      img.onload = function(){
        context.drawImage(img, 10, baseLine+10, 46, 60);
      };
